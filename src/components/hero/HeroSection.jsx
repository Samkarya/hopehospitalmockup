  ...
  return (
    <Box sx={{ position: 'relative', bgcolor: 'background.default' }}>
      ...
      <Box sx={{
        ...
        width: '100%',
        backgroundImage: 'linear-gradient(to right, rgba(0, 95, 115, 0.9), rgba(0, 95, 115, 0.4)), url("https://images.unsplash.com/photo-1638202993928-7267aad84c31?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80")', // Generic medical image
          ...
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={7} sx={{ color: 'white', pt: { xs: 8, md: 0 } }}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button variant="contained" color="warning" size="large" endIcon={<ArrowForwardIcon />}>
                  Find a Doctor
                </Button>
            ...
            <Grid item xs={12} md={5} sx={{ display: 'flex', justifyContent: 'center' }}>
              <Paper elevation={6} sx={{
                ...
                <Stack spacing={2}>
                  ...
                  <Button variant="contained" color="primary" fullWidth size="large" sx={{ py: 1.5 }}>
                    Book Now
                  </Button>
      ...
      <Container maxWidth="lg" sx={{ mt: { xs: 6, md: 2 }, mb: 4 }}>
         <Grid container spacing={2} justifyContent="center" alignItems="center">
            {['PM-JAY', 'CGHS', 'NABH', 'CASHLESS TPA'].map((badge) => (
                <Grid item xs={6} sm={3} key={badge} sx={{ textAlign: 'center' }}>
                    <Box sx={{ 
